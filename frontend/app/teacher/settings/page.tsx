    ...
    >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-ink-text-muted">用于答疑和批改的 LLM 模型</p>
            </div>
            <span className="rounded-lg bg-ink-primary-lighter px-3 py-1 text-xs font-medium text-ink-primary">
              GPT-5.4
            </span>
          </div>
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-lg bg-ink-success-light px-3 py-1 text-xs font-medium text-ink-success">
              已启用
            </span>
          </div>
          <div className="flex items-center justify-between">
      ...
      <div className="rounded-xl border border-ink-border bg-white p-6 space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-ink-text">超星学习通 (LTI 1.3)</p>
              <p className="text-xs text-ink-text-muted">通过 LTI 协议嵌入超星平台</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-ink-text-muted">H5 微应用 + Webhook 通知</p>
            </div>
            <span className="rounded-lg bg-ink-surface px-3 py-1 text-xs font-medium text-ink-text-muted">
              待配置
            </span>
